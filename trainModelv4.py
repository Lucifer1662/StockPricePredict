...
def trainCharacteristic(name, suffix, characteristicIndex, callbacks):
    ...
    try:
        ...
        x = layers.Dense(30, activation=tf.nn.tanh, name="dense_1")(inputs)
        # x = layers.Dense(20, activation=tf.nn.tanh, name="dense_2")(x)
        outputs = layers.Dense(1, activation=tf.nn.tanh, name="predictions")(x)
