...
(xD,yD) = loadTraining("etf", "trainingValue/")
...
def trainCharacteristic(name, suffix, characteristicIndex, callbacks):
    ...
    try:
        ...
        x = layers.Dense(100, activation=sig1, name="dense_1")(inputs)
        x = layers.Dense(40, activation=sig1, name="dense_2")(x)
        outputs = layers.Dense(1, activation=sig1, name="predictions")(x)
